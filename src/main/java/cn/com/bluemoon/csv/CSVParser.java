// Generated from E:/code/antlranalyse/g\CSV.g4 by ANTLR 4.9.1
...
public class CSVParser extends Parser {
	...
	public static final int
		RULE_file = 0, RULE_header = 1, RULE_row = 2, RULE_filed = 3;
	private static String[] makeRuleNames() {
		return new String[] {
			"file", "header", "row", "filed"
		};
	}
	...
	public static class RowContext extends ParserRuleContext {
		public List<FiledContext> filed() {
			return getRuleContexts(FiledContext.class);
		}
		public FiledContext filed(int i) {
			return getRuleContext(FiledContext.class,i);
		}
	...
	public static class FiledContext extends ParserRuleContext {
		public FiledContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_filed; }
	 
		public FiledContext() { }
		public void copyFrom(FiledContext ctx) {
			super.copyFrom(ctx);
		}
	}
	public static class StringContext extends FiledContext {
		public TerminalNode STRING() { return getToken(CSVParser.STRING, 0); }
		public StringContext(FiledContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
	...
	public static class TextContext extends FiledContext {
		public TerminalNode TEXT() { return getToken(CSVParser.TEXT, 0); }
		public TextContext(FiledContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
	...
	public static class EmptyContext extends FiledContext {
		public EmptyContext(FiledContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
	...
	public final FiledContext filed() throws RecognitionException {
		FiledContext _localctx = new FiledContext(_ctx, getState());
		enterRule(_localctx, 6, RULE_filed);
		try {
			setState(32);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
